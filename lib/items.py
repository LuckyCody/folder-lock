...
adds the fields the autorun loop needs, in one runtime file `<state>/items.yaml`:
...
def save(data: dict) -> None:
    ...
    tmp.write_text("# generated by lib/items.py — board item status overlay for the autorun loop (never hand-edit)\n"
                   + yaml.safe_dump(data, allow_unicode=True, sort_keys=True, width=140), encoding="utf-8")
    tmp.replace(STATE)
